<?php
    ...
    $codigoEquipe = strip_tags(trim($_POST['pao']));
    ...
    $instrucaoCapitao = "SELECT usuario.nome as nomeMembro,
                                usuario.ra as ra,
                                usuario.posicao as posicao
                         FROM usuario, equipe 
                         WHERE equipe.codigoUsuario = usuario.codigoUsuario
                         AND equipe.codigoEquipe = $codigoEquipe;";
    ...
    $exibeCapitao = $conn -> query($instrucaoCapitao);
?>
<!doctype html>
<html>
<head>
...
<body class="single-equipe">
	<center>
            ...
            <div class="row">
                <div class="col-sm-12">
					...
					?>
                        ...
                        <div class="foto" style="background: url(images/<?php echo $equipe['foto']; ?>);"></div>
                        ...
                        <?php 
                            ...
                            while ($capitao = $exibeCapitao -> fetch(PDO::FETCH_ASSOC)) { ?>
                               <article style="margin: 30px 0">
                                    <div class="nomeMembro"><p><b>Nome: </b><?php echo($capitao['nomeMembro']);?></p></div>
                                    <div class="ra"><p><b>RA: </b><?php echo($capitao['ra']);?></p></div>
                                    <div class="<?php echo($capitao['posicao']);?>">
                                        <p><b>Posição: </b><span><?php echo($capitao['posicao']);?></span></p>
                                    </div>
                                </article>

                        <?php } ?>
                       
						<?php	while($membros = $exibeMembros -> fetch(PDO::FETCH_ASSOC)){ ?>
        ...
        <div class="link">
        	<a href="visualizaEquipe.php">
            	<span class="glyphicon glyphicon-arrow-left"></span>
            	Voltar para a visualização de equipes
            </a>
        </div>
    </center>
</body>
